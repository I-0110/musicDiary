  ...
  return (
    <header className="relative bg-[url('/jungle.jpg')] bg-cover bg-top py-12 px-4 text-center">
      ...
      <div className="relative z-10 text-center">
        ...
        <Link className="text-light" to="/">
          <p className="bg-light-accent text-white dark:bg-dark-background px-6 py-2 rounded shadow-md hover:opacity-90 transition" style={{ fontSize: '1.75rem', fontWeight: '700' }}>
